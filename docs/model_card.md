**Technical model card** for MLS Recruitment Intelligence.
...
| --- | --- | --- |
| 2026-07-23 | 0.3.0 | Unvalidated heuristic; assumed league factors; fixed shrinkage m0=600; decision-support labels only |
